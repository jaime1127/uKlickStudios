...
declare module '$env/static/private' {
	...
	export const npm_package_peerDependencies_typescript: string;
	export const npm_package_scripts_build_storybook: string;
	export const npm_package_scripts_check: string;
	export const npm_package_scripts_format: string;
	export const npm_package_scripts_gql_gen: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_peerDependencies_typescript: string;
		npm_package_scripts_build_storybook: string;
		npm_package_scripts_check: string;
		npm_package_scripts_format: string;
		npm_package_scripts_gql_gen: string;
